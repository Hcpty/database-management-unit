...
- 第2级是 (Table) Partition ID，只要求在对应的Database中具有唯一性，隐含的Resource Type串联Partition ID就是表名。
...
存在一些预定义的常量，例如一个Database中最大允许多少个Table Partition、一个Table Partition中最大允许多少条Record。
